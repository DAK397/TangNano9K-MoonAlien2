Moon Alien Part II Arcade for the Tang Nano 9K FPGA Dev Board. Pinballwiz.org 2025
Original Code by Katsumi Degawa.

Notes:
Setup for keyboard controls in Upright mode (5 = Coin) (Start P1 = 1) (Start P2 = 2)(LCtrl = Fire) (Arrow Keys = Move L or R)
Consult the Schematics Folder for Information regarding peripheral connections.

Build:
* Obtain correct roms file for Moon Alien Part II (see scripts in tools folder for rom details).
...
* Open the TangNano9k-MoonAlien2 project file using GoWin.
